...
print(chain_combined.invoke({'job title':'neurosurgeon'}))
...
long_result = chain_long.invoke({'job title':'neurosurgeon'})
heading("Chain Long")
print(long_result)