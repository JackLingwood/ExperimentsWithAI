# Step 2 in Equipping a chatbot with memory - Reducer Functions In Action
# This Chatbot keeps context and memory of previous interactions using reducer functions.
...
heading(f"{name} LangGraph - Reducer Functions in Action")
